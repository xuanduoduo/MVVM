...
import com.chenxuan.login.databinding.BusinessLoginActivityBinding
...
class LoginActivity :
    BaseActivity<LoginViewModel, LoginRepository, BusinessLoginActivityBinding>() {
    override fun createViewBinding() = BusinessLoginActivityBinding.inflate(layoutInflater)
