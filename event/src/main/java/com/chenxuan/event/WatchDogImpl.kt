...
class WatchDogImpl : IWatchDog, LifecycleEventObserver {
    ...
    override fun unWatch(target: Any) {
        val watchMethods = events[target]
    ...
    private fun getWatchMethods(target: Any): List<WatchMethod> {
        ...
        clazz.declaredMethods.forEach {
            ...
            if (params[0].interfaces.contains(IWatchBean::class.java)) {
